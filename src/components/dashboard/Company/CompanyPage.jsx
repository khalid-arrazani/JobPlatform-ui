    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box sx={{ height: "35% ", width: "100%", bgcolor: "#ffffff", pl:"14vw",position: "relative"  }}>
           
           <Card sx={{ height: "8.5rem ", width: "8.5rem", bgcolor: "#fffafa" ,position:"absolute", top:"-60%",left:"2%",borderRadius:"15px"}}>
