          ...
          <IconButton size="small">
            ...
            >
              <svg
                ...
                fill="none"
                viewBox="0 0 24 24"
                id="Bell--Streamline-Guidance-Free"
                height="30"
                width="30"
              >
                ...
                <path
                  stroke="#000000"
                  d="M14.5 20a2.5 2.5 0 0 1 -5 0m13 -2.5h-21v-0.25l0.848 -0.908a12 12 0 0 0 3.134 -6.7l0.336 -2.684a6.23 6.23 0 0 1 12.364 0l0.336 2.685a12 12 0 0 0 3.134 6.699l0.848 0.908v0.25Z"
                  stroke-width="1"
                ></path>
              </svg>
            </Box>
