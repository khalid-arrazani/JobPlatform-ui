      ...
      >
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Autocomplete
            ...
            value={hiringTypes}
            onChange={(e, newValue) => setHiringTypes(newValue)}
            ...
            renderInput={(params) => (
              <TextField {...params} placeholder="Select hiring types..." />
            )}
          />
        </Box>
...
export default HiringFocusModal;
